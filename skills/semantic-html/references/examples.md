...
Before/after markup for each rule section in `SKILL.md`. Loaded on demand — read this file when a finding needs a
concrete corrected snippet. Each pair shows the violation first, then the accessible form.
